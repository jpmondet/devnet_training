...
class L2Controller(object):
    ...
    def learn(self, learning_data):
        ...
        for mac_addr, ingress_port in  learning_data:
            ...
            self.controller.table_add("MyIngress.smac", "NoAction", [str(mac_addr)])
            self.controller.table_add("MyIngress.dmac", "MyIngress.forward", [str(mac_addr)], [str(ingress_port)])
